    ...
    return AspectRatio(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ListTile(
              contentPadding: EdgeInsets.only(right: 32, left: 31, top: 16 , bottom: 0),
              title: Text(
                'Name card',
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text('0918 8124 0042 8129', style: AppStyles.textSimiBold24.copyWith(color: Colors.white)),
                  Text('12/20 - 124', style: AppStyles.textRegular16.copyWith(color: Colors.white)),
                ],
              ),
            ),
          ],
